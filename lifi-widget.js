...
.edge-logo {
  content: url(data:image/webp;base64,);
  width: 24px;
  height: 24px;
}
...
.search-icon {
  ...
  cursor: pointer;
  margin: 0;
  content: url(data:image/svg+xml;base64,);
}
    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$443129125$-->
            <p>似乎 <strong>cdn.li.fi</strong> 关闭了连接。</p>
          
          <div id="diagnose-frame" class="hidden"></div>

          <!--?lit$443129125$-->
            <div id="suggestions-list">
              <p><!--?lit$443129125$-->请尝试：</p>
              <ul class="">
                <!--?lit$443129125$--><!---->
                  <li>检查连接</li>
                <!----><!---->
                  <li><a href="chrome-error://chromewebdata/#buttons" onclick="toggleHelpBox()">检查代理和防火墙</a></li>
                <!---->
              </ul>
            </div>
          

          <div class="error-code"><!--?lit$443129125$-->ERR_CONNECTION_CLOSED</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-left">
        <div id="control-buttons">
          <!--?lit$443129125$-->
      <!--?lit$443129125$-->
        <button id="reload-button" class="blue-button text-button" data-url="https://cdn.li.fi/widget/v3/index.min.js">
          <!--?lit$443129125$-->刷新
        </button>
      <!--?-->
        </div>
      ...
      <!--?lit$443129125$-->
        <div id="details">
          <!--?lit$443129125$--><!---->
            <div class="suggestions">
              <div class="suggestion-header">检查 Internet 连接</div>
              <div class="suggestion-body">请检查你的网络电缆、调制解调器和路由器。</div>
            </div>
          <!----><!---->
            <div class="suggestions">
              <div class="suggestion-header">要允许 Microsoft Edge 访问网络，请在防火墙或防病毒软件中进行
          设置。</div>
              <div class="suggestion-body">如果它已被列为允许访问网络的程序，请尝试
将其从列表中删除，然后重新添加。</div>
            </div>
          <!----><!---->
            <div class="suggestions">
              <div class="suggestion-header">如果使用代理服务器:</div>
              <div class="suggestion-body">转到
          “MICROSOFT EDGE”菜单 &gt;
          <span jscontent="settingsTitle">设置</span>
          &gt;
          <span jscontent="advancedTitle">系统</span>
          &gt;
          <span jscontent="proxyTitle">打开计算机的代理设置</span>
          &gt;
          LAN 设置
          并取消选中“为 LAN 使用代理服务器”复选框。</div>
            </div>
          <!---->
        </div>
    ...
    <!--?lit$443129125$-->
      <div class="footer">
        <div class="left-footer">
          <div class="edge-logo" alt=""></div>
          <div class="edge-branding-text"><!--?lit$443129125$-->Microsoft Edge</div>
        </div>
      </div>
    ...
    <!--?lit$443129125$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">似乎 <strong>cdn.li.fi</strong> 关闭了连接。</div>
      </div>
...
<script>var loadTimeDataRaw = {"details":"详细信息","errorCode":"ERR_CONNECTION_CLOSED","fontfamily":"'Segoe UI',Arial,'Microsoft Yahei',sans-serif","fontfamilyMd":"'Segoe UI',Arial,'Microsoft Yahei',sans-serif","fontsize":"75%","footer":{"msg":"Microsoft Edge"},"heading":{"msg":"嗯… 无法访问此页面"},"hideDetails":"隐藏详细信息","iconClass":"icon-elixir-thinking","is_windows_xbox_sku":"false","language":"zh","reloadButton":{"msg":"刷新","reloadUrl":"https://cdn.li.fi/widget/v3/index.min.js"},"suggestionsDetails":[{"body":"请检查你的网络电缆、调制解调器和路由器。","header":"检查 Internet 连接"},{"body":"如果它已被列为允许访问网络的程序，请尝试\n将其从列表中删除，然后重新添加。","header":"要允许 Microsoft Edge 访问网络，请在防火墙或防病毒软件中进行\n          设置。"},{"body":"转到\n          “MICROSOFT EDGE”菜单 >\n          \u003Cspan jscontent=\"settingsTitle\">设置\u003C/span>\n          >\n          \u003Cspan jscontent=\"advancedTitle\">系统\u003C/span>\n          >\n          \u003Cspan jscontent=\"proxyTitle\">打开计算机的代理设置\u003C/span>\n          >\n          LAN 设置\n          并取消选中“为 LAN 使用代理服务器”复选框。","header":"如果使用代理服务器:"}],"suggestionsSummaryList":[{"summary":"检查连接"},{"summary":"\u003Ca href=\"#buttons\" onclick=\"toggleHelpBox()\">检查代理和防火墙\u003C/a>"}],"suggestionsSummaryListHeader":"请尝试：","summary":{"msg":"似乎 \u003Cstrong>cdn.li.fi\u003C/strong> 关闭了连接。"},"textdirection":"ltr","title":"cdn.li.fi"};</script></body></html>